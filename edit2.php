<?php  
	...
	if (!isset($_SESSION['nim']) || isset($_SESSION['role'])) {
		...
		$sql	= "SELECT * FROM maba WHERE nim='".$_SESSION['nim']."'";
				...
				<div class="col-md-6">
					<div class="panel <?= $panel_pribadi_class ?>">
					  ...
					  <div class="panel-body">
					    ...
					    <div class="form-group">
					    	<label for="ukt">UKT <i>(diisi dengan angka saja, contoh: 1000000)</i></label>
					  ...
					  <div class="panel-body">
					    <div class="panel panel-info">
						  ...
						  <div class="panel-body">
						    ...
						    <div class="form-group">
						    	<label for="penghasilan_ayah">Penghasilan Ayah (per bulan) <i>(diisi dengan angka saja, contoh: 1000000)</i></label>
						...
						<div class="panel panel-info">
						  ...
						  <div class="panel-body">
						    ...
						    <div class="form-group">
						    	<label for="penghasilan_ibu">Penghasilan Ibu (per bulan) <i>(diisi dengan angka saja, contoh: 1000000)</i></label>
						...
						<div class="panel panel-info">
						  ...
						  <div class="panel-body">
						    ...
						    <div class="form-group">
						    	<label for="penghasilan_wali">Penghasilan Wali (per bulan) <i>(diisi dengan angka saja, contoh: 1000000)</i></label>
						...
						<div class="form-inline">
							<?php if (isset($anak_ke) && $anak_ke != ''): ?>
								<div class="form-group">
									<input class="form-control" type="text" name="anak_ke" value="<?= $anak_ke[0] ?>" />
								</div>
								<div class="form-group">
									<label for="saudara"> dari </label>
									<input class="form-control" type="text" name="saudara" value="<?= $anak_ke[1] ?>" />
